...
import torch
import correspondences as corr
...
mask2_path = os.path.join(masks_path, f"{str(i).zfill(6)}{assets_data_type}")
with torch.no_grad():
  points1, points2, image1_pil, image2_pil = corr.find_correspondences(image1_path,image2_path)
  corr.draw_correspondences(points1,points2,image1_pil,image2_pil)
